...
with open ("data/MI_vs_p_with_boundaries_1to13range.ob", 'rb') as fp:
...
left, bottom, width, height = [0.5625, 0.268, 0.3933, 0.202]
...
ax1.set_yscale("log")
ax1.set_xscale("log")
ax1.set_ylabel(r"$\mathcal{I}_\infty$",rotation=0)
ax1.set_yticks([10,0.1])
...
ax2.yaxis.set_ticks([10**(-1),20],[r"$10^{-1}$", r"$2\times 10^1$"])
ax2.xaxis.set_ticks([30.0,100, 300], [r"$30$", "", r"$3\times 10^2$"])
...
ax3.set_ylabel(r"$\mathcal{I}_\infty$",rotation=0)
ax3.set_xlabel(r"$p$")
ax3.set_yticks([1,0.1])
ax3.set_xticks([1.0,1.1,1.2,1.3])
ax3.yaxis.set_label_coords(-0.09,0.45)
...
# ax.set_yscale('log')
ax3_inset.set_ylabel(r"$\mathcal{I}_\infty$", fontsize=8, rotation=0)
ax3_inset.set_xlabel(r"$L^{1/\nu}(p-p_c)$",fontsize=7)
ax3_inset.set_xticks([])
ax3_inset.set_yticks([])
ax3_inset.xaxis.set_label_coords(0.5, -0.05)
ax3_inset.yaxis.set_label_coords(-0.075,0.45)

# send it!
plt.tight_layout()
plt.show()
#plt.savefig("paper_figs/images/MI_with_boundaries_fig.pdf")
