...
##############################
res = minimize(O_ipr, np.array([1,1,1]), method='Powell',options={'disp': True, "maxiter": 1000}, bounds=((0,2),(0,None),(0,0)),tol=1e-20)
...
data_in=np.load("data/AVG_IPR_joined_data.npy")
...
# with open("data/ipcollapse_data_w_b.ob", 'wb') as fp:
